...
Astro + Tailwind marketing/event site for The Convention (Kristiansund LAN/gaming/cosplay event). Deployed to Netlify.
...
- `netlify/functions/` — Netlify Function for the email signup form.
